    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                {{ Form::text('name', $clients->name, ['id'=>'name', 'class'=>'form-control has-feedback-left', 'required'=>'required', 'placeholder'=>'Razón social']) }}
                <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
            </div>
            <div class="col-md-9 col-sm-9 col-xs-12 form-group has-feedback">
                {{ Form::text('id_document', $clients->id_document, ['id'=>'id_document', 'class'=>'form-control has-feedback-left', 'required'=>'required', 'placeholder'=>'Númeror de Identificación Tributaria']) }}
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                {{ Form::text('work_fax', $clients->work_fax, ['id'=>'work_fax', 'class'=>'form-control', 'placeholder'=>'Telefax']) }}
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                {{ Form::textarea('work_address', $clients->work_address, ['id'=>'work_address', 'class'=>'form-control', 'size'=>'10x2', 'placeholder'=>'Dirección']) }}
            </div>
        </div>
    </div>
</div>
<div class="col-md-6 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                {{ Form::text('representative_name', $clients->representative_name, ['id'=>'representative_name', 'class'=>'form-control has-feedback-left', 'placeholder'=>'Nombre completo']) }}
                <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
            </div>
            <div class="col-md-6 col-sm-12 col-xs-12 form-group has-feedback">
                {{ Form::text('representative_id_document', $clients->representative_id_document, ['id'=>'representative_id_document', 'class'=>'form-control has-feedback-left', 'placeholder'=>'Cédula de identidad']) }}
                <span class="fa fa-credit-card form-control-feedback left" aria-hidden="true"></span>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                {{ Form::text('representative_phone', $clients->representative_phone, ['id'=>'representative_phone', 'class'=>'form-control has-feedback-right', 'placeholder'=>'Teléfono móvil']) }}
                <span class="fa fa-mobile form-control-feedback right" aria-hidden="true"></span>
            </div>
            <div class="col-md-9 col-sm-6 col-xs-12 form-group has-feedback">
                {{ Form::email('representative_email', $clients->representative_email, ['id'=>'representative_email', 'class'=>'form-control has-feedback-left', 'placeholder'=>'Correo electrónico']) }}
