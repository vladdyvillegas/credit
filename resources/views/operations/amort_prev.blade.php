        ...
        <div class="">
            ...
            <form id="payment_plan" data-parsley-validate class="form-horizontal form-label-left input_mask" action="{{ url('operation_amort_prev', $operation->id) }}" method="post">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                        <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-9 col-xs-12">
                                {{ Form::text('voucher_number', $voucher_number, ['id'=>'voucher_number', 'class'=>'form-control']) }}
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-2 col-sm-3 col-xs-3">Fecha de amortización</label>
                            <div class="col-md-2 col-sm-9 col-xs-12">
                                {{ Form::text('amort_date', $amort_date, ['id'=>'amort_date', 'class'=>'form-control', 'required'=>'required']) }}
                            </div>
                            ...
                            <div class="col-md-2 col-sm-9 col-xs-12">
                                {{ Form::text('interest_accrued', number_format($interest_accrued, 2, '.', ''), ['id'=>'interest_accrued', 'class'=>'form-control', 'readonly'=>'readonly']) }}
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-9 col-xs-12">
                                ...
                                {{ Form::hidden('payterm', $operation->payment_term, ['id'=>'payterm', 'class'=>'form-control']) }}
                            </div>
                            <label class="control-label col-md-2 col-sm-3 col-xs-3">Interés por mora</label>
                            <div class="col-md-2 col-sm-9 col-xs-12">
                                {{ Form::number('interest_late', $interest_late, ['id'=>'interest_late', 'step'=>'any', 'min'=>'0', 'max'=>$operation->last_balance, 'class'=>'form-control']) }}
                            </div>
                            <label class="control-label col-md-2 col-sm-3 col-xs-3">Capital a amortizar</label>
                            <div class="col-md-2 col-sm-9 col-xs-12">
                                {{ Form::number('capital_fee', $capital_fee, ['id'=>'capital_fee', 'step'=>'any', 'min'=>'0', 'max'=>$operation->last_balance, 'class'=>'form-control']) }}
              ...
              <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                  @if($amort_mode=='normal')
                    @include('operations.partials.amort_normal')
                  @elseif($amort_mode=='red_cuota')
                    @include('operations.partials.amort_red_cuota')
                  @elseif($amort_mode=='red_plazo')
                    @include('operations.partials.amort_red_plazo')
                  @elseif($amort_mode=='liquida')
                    @include('operations.partials.amort_liquida')
                  @elseif($amort_mode=='rec_mora')
                    @include('operations.partials.amort_rec_mora')
                  @else
                    &nbsp;
                  @endif
                  </div>
...
<script>
    $('#amort_date').Zebra_DatePicker({
        ...
        onSelect: function() {
          ...
          var cuota = balance*dias*(delayed/100/payterm/frequency);
