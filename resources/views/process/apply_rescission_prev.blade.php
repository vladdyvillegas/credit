            ...
            <form id="payment_plan" data-parsley-validate class="form-horizontal form-label-left input_mask" action="{{ url('apply_rescission_prev', $operation->id) }}" method="post">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="form-group">
                                ...
                                <div class="col-md-2 col-sm-9 col-xs-12">
                                    {{ Form::text('rescission_date', $rescission_date, ['id'=>'rescission_date', 'class'=>'form-control', 'required'=>'required']) }}
                                </div>
                                ...
                                <div class="col-md-2 col-sm-9 col-xs-12">
                                    {{ Form::number('rescission_discount', number_format(($rescission_discount), 2, '.', ''), ['id'=>'rescission_discount', 'step'=>'any', 'min'=>'0', 'max'=>$rescission_payments, 'class'=>'form-control']) }}
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-3 col-xs-3">Total pagado</label>
                                <div class="col-md-2 col-sm-9 col-xs-12">
                                    {{ Form::text('rescission_payments_apply', number_format(($rescission_payments), 2, '.', ''), ['id'=>'next_variable_fee', 'class'=>'form-control', 'readonly'=>'readonly']) }}
                                </div>
                                <label class="control-label col-md-2 col-sm-3 col-xs-3">Descuento por uso</label>
                                <div class="col-md-2 col-sm-9 col-xs-12">
                                    {{ Form::number('rescission_discount_apply', number_format(($rescission_discount), 2, '.', ''), ['id'=>'rescission_discount', 'step'=>'any', 'min'=>'0', 'max'=>$rescission_payments, 'class'=>'form-control', 'readonly'=>'readonly']) }}
                                </div>
                                <label class="control-label col-md-2 col-sm-3 col-xs-3">Total final</label>
                                <div class="col-md-2 col-sm-9 col-xs-12">
                                    {{ Form::number('final', number_format(($rescission_payments-$rescission_discount), 2, '.', ''), ['id'=>'rescission_discount', 'step'=>'any', 'min'=>'0', 'max'=>$rescission_payments, 'class'=>'form-control', 'readonly'=>'readonly']) }}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="x_panel">
                    <div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-4">
                        {!! Form::submit('Riscindir por mutuo acuerdo', ['id'=>'process_ok', 'name'=>'process_ok', 'class'=>'btn btn-success']) !!}
                    </div>
                </div>
            </form>
            <!--/form-->
